        ...
        <div class="col-8 mx-auto">
            ...
            <form class="p-5 border mb-5" method="POST" action="<?php url('product/update/'.$row['id']); ?>">
                ...
                <div class="form-group">
                    ...
                    <input type="text" required class="form-control" name="description" value="<?php echo $row['description']; ?>" id="description">
                </div>

                <div class="form-group">
                    <label for="qty">Quantity</label>
                    <input type="number" required class="form-control" name="qty" value="<?php echo $row['qty']; ?>" id="qty">
                </div>
